...
############################################################################################################
# Implementation of Fully Convolutional Network - 8 from https://arxiv.org/abs/1411.4038.                 #
...
# Also note that this implementation assumes you start by training the FCN-16 and use this network to      #
# initialize this model. For more comment regarding code see FCN-32 and FCN-16 model.                                                                                   #
############################################################################################################
